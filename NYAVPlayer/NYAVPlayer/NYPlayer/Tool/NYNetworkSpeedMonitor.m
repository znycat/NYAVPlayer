...
NSString *const NYDownloadNetworkSpeedNotificationKey = @"NYDownloadNetworkSpeedNotificationKey";
NSString *const NYUploadNetworkSpeedNotificationKey   = @"NYUploadNetworkSpeedNotificationKey";
NSString *const NYNetworkSpeedNotificationKey         = @"NYNetworkSpeedNotificationKey";

@interface NYNetworkSpeedMonitor () {
    // 总网速
    uint32_t _iBytes;
    uint32_t _oBytes;
    uint32_t _allFlow;
...
@implementation NYNetworkSpeedMonitor
...
- (void)checkNetworkSpeed {
    ...
    if (_iBytes != 0) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:NYDownloadNetworkSpeedNotificationKey object:nil userInfo:@{NYNetworkSpeedNotificationKey:_downloadNetworkSpeed}];
//        ZFPlayerLog(@"downloadNetworkSpeed : %@",_downloadNetworkSpeed);
    ...
    if (_oBytes != 0) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:NYUploadNetworkSpeedNotificationKey object:nil userInfo:@{NYNetworkSpeedNotificationKey:_uploadNetworkSpeed}];
